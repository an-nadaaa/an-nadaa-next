    ...
    <div class="px-4 py-16 mx-auto max-2xl sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      <div class="max-w-xl">
        ...
        <p class="mt-4 text-base text-gray-500">
          ...
          always
          <a href="/contact" class="font-medium text-primary-600 hover:text-primary-500">Contact us</a>
          with your enquiry.
        </p>
      </div>
  ...
  meta: [
    {
      hid: 'description',
      name: 'description',
      content: 'Frequently asked questions addresses the most common questions asked for our educational foundation',
    },
  ],
})
...
const { data: faqs } = await useAsyncData(
  'faq',
  () => queryContent('faq', locale.value).sort({ date: -1 }).find() as unknown as Promise<FAQ[]>
)
