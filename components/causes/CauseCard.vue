<template>
  ...
  >
    ...
    <div
      class="bottom-0 flex-col justify-between flex-1 w-full p-6 bg-white bg-center bg-cover"
    >
      <div class="flex-1">
        <span
      ...
      <div
        v-else
        class="inline-flex items-center my-3 text-green-800 bg-green-100 px-2.5 py-0.5 rounded-md"
      >
      ...
      <div class="flex items-center mt-6">
        <div>
          ...
          >
            ...
            <span> of </span>
            <span>
              {{ formateAmount(cause.attributes.dynamicZone[0].goal) }} Raised
            </span>
          </div>
          <div
