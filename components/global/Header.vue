        ...
        <nav class="flex space-x-10">
            ...
            >
              ...
              <ChevronDownIcon
                :class="`w-5 h-5 ml-2 group-hover:text-gray-500 ${
                  showCauses ? 'text-gray-600' : 'text-gray-400'
                }`"
              />
            </button>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="ml-4">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                          A perpetual way to give to those who need.
                        </p>
                      </div>
                    </NuxtLink>
                  </div>
                  <div class="p-5 bg-gray-50 sm:p-8">
                    <a
                      href="#"
                      class="flow-root p-3 -m-3 rounded-md hover:bg-gray-100"
                    >
          ...
          <div class="relative" v-on-click-outside="clickOutsideLearn">
            ...
            >
              ...
              <ChevronDownIcon
                :class="`w-5 h-5 ml-2 group-hover:text-gray-500 ${
                  showLearn ? 'text-gray-600' : 'text-gray-400'
                }`"
              />
            </button>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <p class="mt-1 text-sm text-gray-500">
                        See the most recent educative posts.
                      </p>
                    </a>
                    ...
                    >
                      ...
                      <p class="mt-1 text-sm text-gray-500">
                        Brows through the lectures and videos of Shaykh Ibrahim.
                      </p>
                    </a>
                  </div>
                </div>
