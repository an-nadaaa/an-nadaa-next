<template>
  <div id="donate" class="py-16 bg-white sm:py-24">
    <div class="relative sm:py-16">
      ...
      <div
        class="max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:max-w-6xl lg:px-8"
      >
        <div
          class="relative px-6 py-10 overflow-hidden shadow-xl bg-primary-700 rounded-2xl sm:px-12 sm:py-20"
        >
          <div
            aria-hidden="true"
          ...
          <div class="relative">
            ...
            <ClientOnly placeholder="Loading...">
              <form
                action="#"
                class="items-center mt-12 sm:mx-auto sm:max-w-lg sm:flex"
