<template>
  <div class="w-full px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
    <div
      class="px-6 py-10 bg-primary-800 rounded-3xl sm:py-16 sm:px-12 lg:p-20 lg:flex lg:items-center"
    >
      <div class="lg:w-0 lg:flex-1">
        <h2 class="text-3xl tracking-tight text-white font-headers">
          Join our newsletter
        </h2>
        <p class="max-w-3xl mt-4 text-lg text-primary-200">
          Get the latest new projects, updates on ongoing causes and new
          lectures right into your inbox.
        </p>
      </div>
      <div class="mt-12 sm:w-full sm:max-w-md lg:mt-0 lg:ml-8 lg:flex-1">
        ...
        >
          ...
          <div style="position: absolute; left: -5000px" aria-hidden="true">
            <input
              type="text"
              name="b_6121dee1d3173d0593a42fa31_c61f24d44c"
              tabindex="-1"
              value=""
            />
          </div>
